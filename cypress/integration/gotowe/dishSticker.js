...
describe('dish stickers', () => {
    ...
    it('login', () => {
        cy.visit('/admin/reports/dish-labels');
    ...
    it('choice start day', () => {
        ...
        cy.get('.input-datetime--date>.rdtPicker>.rdtDays>table>tbody>tr>td').not('.rdtOld').contains(actualDay).click()
    }) 

    it('verify download xlsx',()=>{
        cy.intercept({
            method: "GET",
            url: "/reports/dish-stickers*",
          }).as("xslsReport");
